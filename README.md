...
## How to Run?
```
git clone https://github.com/SophiaAr/DeepLearningFlappyBird.git
...
Change [first line of `saved_networks/checkpoint`](https://github.com/SophiaAr/DeepLearningFlappyBird/blob/master/saved_networks/checkpoint#L1) to 

`model_checkpoint_path: "saved_networks/bird-dqn-2920000"`

#### How to reproduce?
1. Comment out [these lines](https://github.com/SophiaAr/DeepLearningFlappyBird/blob/master/deep_q_network.py#L108-L112)
...
3. [yenchenlin1994/DeepLearningFlappyBird](https://github.com/yenchenlin1994/DeepLearningFlappyBird.git)
